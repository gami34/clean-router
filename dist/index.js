...
function routeWrapper(path, component, loader, subComponent) {
  if (subComponent !== null && subComponent !== void 0 && subComponent.length) return React__default.createElement(reactRouterDom.Route, {
    path: path,
    element: React__default.createElement(React.Suspense, {
      fallback: loader
    }, component)
    ...
    var path1 = _ref2[0],
      ...
      loader = _ref2[2],
      subRoutes = _ref2[3];
    if (subRoutes !== null && subRoutes !== void 0 && subRoutes.length) return React__default.createElement(reactRouterDom.Route, {
      key: idx,
      path: path1,
      element: React__default.createElement(React.Suspense, {
        fallback: loader
